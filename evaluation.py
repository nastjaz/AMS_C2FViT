...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='L2R Evaluation script\n'
                                     ...
                                     'DEFAULT_GROUND_TRUTH_PATH = Path("/workspace/data/Release_06_12_23")\n'
                                     'DEFAULT_EVALUATION_OUTPUT_FILE_PATH = Path("/output/metrics.json")')
    parser.add_argument("-i", "--input", dest="input_path",
                        help="path to deformation_field", default="/input")
    parser.add_argument("-d", "--data", dest="gt_path",
                        help="path to data", default="/workspace/data/Release_06_12_23")
    parser.add_argument("-o", "--output", dest="output_path",
                        help="path to write results(e.g. 'results/metrics.json')", default="/output/metrics.json")
    parser.add_argument("-c", "--config", dest="config_path",
                        help="path to config json-File (e.g. 'evaluation_config.json')", default='/workspace/data/configs/ThoraxCBCT_VAL_evaluation_config.json')
